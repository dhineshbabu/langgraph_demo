...
# Reducer Function: Rule that controls how updates from nodes are combines with the existing state
    ...
    # in the above imports, add_messages is a reducer function
...
inputs = {"messages": [("user", "Add 40 + 12 and Add 4 + 9.")]}
